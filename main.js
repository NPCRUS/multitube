...
var $author$project$Components$CustomStream$streamToolbarStyle = _List_fromArray(
	[
...
var $author$project$Components$CustomStream$toolbarIconStyle = _List_fromArray(
	[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$span,
				_Utils_ap(
					$author$project$Components$CustomStream$toolbarIconStyle,
					_List_fromArray(
						[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$div, $author$project$Styles$toolbarBlockStyle, _List_Nil),
				A2(
				$elm$html$Html$div,
