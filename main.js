...
var $author$project$Main$init = {
	modal: {inputText: '', isOpened: false},
...
var $author$project$Main$activateStream = F2(
	function (model, stream) {
		var newList = _Utils_ap(
			...
			A2(
				...
				function (a) {
					return !_Utils_eq(a.source, stream.source);
				},
				model.streams));
...
var $author$project$Main$testRegex = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	$elm$regex$Regex$fromString('\\?v=(\\w*)\\&?'));
var $author$project$Main$updateModalInputText = F2(
	function (inputText, modal) {
		return _Utils_update(
			modal,
			{inputText: inputText});
	});
var $author$project$Main$updateModalIsOpened = F2(
	function (isOpened, modal) {
		return _Utils_update(
			modal,
			{isOpened: isOpened});
	});
var $author$project$Main$updateModelAndAddStream = F2(
	function (source, model) {
		return _Utils_update(
			model,
			{
				modal: A2(
					$author$project$Main$updateModalInputText,
					'',
					A2($author$project$Main$updateModalIsOpened, false, model.modal)),
				streams: _Utils_ap(
					model.streams,
					_List_fromArray(
						[
...
var $author$project$Main$addStream = function (model) {
	var matchMaybe = A2(
		...
		A2(
			...
			$elm$core$List$head(
				A2($elm$regex$Regex$find, $author$project$Main$testRegex, model.modal.inputText))));
	var matchString = function () {
		if (matchMaybe.$ === 'Nothing') {
			return model.modal.inputText;
		} else {
			var m = matchMaybe.a;
			if (m.$ === 'Nothing') {
				return model.modal.inputText;
	...
	return A2($author$project$Main$updateModelAndAddStream, matchString, model);
};
var $author$project$Main$deleteStream = F2(
	function (model, stream) {
		var newList = A2(
			$elm$core$List$filter,
			function (a) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ActivateStream':
				var stream = msg.a;
				return A2($author$project$Main$activateStream, model, stream);
			case 'DeleteStream':
				var stream = msg.a;
				return A2($author$project$Main$deleteStream, model, stream);
			case 'OpenAddStreamModal':
				return _Utils_update(
					model,
					{
						modal: A2($author$project$Main$updateModalIsOpened, true, model.modal)
					});
			case 'CloseAddStreamModal':
				return _Utils_update(
					model,
					{
						modal: A2($author$project$Main$updateModalIsOpened, false, model.modal)
					});
			case 'ChangeAddStreamModalText':
				var inputText = msg.a;
				return _Utils_update(
					model,
					{
						modal: A2($author$project$Main$updateModalInputText, inputText, model.modal)
					});
			default:
				return $author$project$Main$addStream(model);
		}
	});
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$Styles$flex = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'display', 'flex')
	]);
var $author$project$Styles$flexColumn = _Utils_ap(
	$author$project$Styles$flex,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'flex-direction', 'column')
		]));
var $author$project$Styles$activeSpaceBlockStyle = _Utils_ap(
...
var $author$project$Models$ChangeAddStreamModalText = function (a) {
	return {$: 'ChangeAddStreamModalText', a: a};
};
...
var $author$project$Components$StreamAddModal$modalBody = function (inputText) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			$author$project$Styles$flexColumn,
			_Utils_ap(
				$author$project$Components$CustomStream$width100,
				_List_fromArray(
					[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Input video token or link to youtube stream/video')
					])),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Models$ChangeAddStreamModalText)
					]),
				_List_Nil)
			]));
};
var $author$project$Models$CloseAddStreamModal = {$: 'CloseAddStreamModal'};
...
var $author$project$Styles$toolbarIconStyle = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'color', 'rgba(255, 255, 255, 1)'),
		A2($elm$html$Html$Attributes$style, 'font-size', '30px'),
		A2($elm$html$Html$Attributes$style, 'cursor', 'pointer')
	]);
var $author$project$Components$StreamAddModal$modalHeader = A2(
	$elm$html$Html$div,
	_Utils_ap(
	...
	_List_fromArray(
		[
			...
			$elm$html$Html$span,
			_Utils_ap(
				$author$project$Styles$toolbarIconStyle,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('material-icons'),
						$elm$html$Html$Events$onClick($author$project$Models$CloseAddStreamModal)
					])),
			_List_fromArray(
				[
...
var $author$project$Components$StreamAddModal$modalStyle = _Utils_ap(
	$author$project$Styles$flexColumn,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'width', '450px'),
			A2($elm$html$Html$Attributes$style, 'height', '200px'),
			A2($elm$html$Html$Attributes$style, 'background-color', '#FF4838'),
...
var $author$project$Models$ConfirmStreamAdd = {$: 'ConfirmStreamAdd'};
var $elm$html$Html$button = _VirtualDom_node('button');
var $author$project$Components$StreamAddModal$confirmButtonStyle = _List_fromArray(
	[
...
var $author$project$Components$StreamAddModal$modalSubmitSection = A2(
	$elm$html$Html$div,
	_Utils_ap(
		$author$project$Styles$flexRow,
		_Utils_ap(
	...
	_List_fromArray(
		[
			...
			_Utils_ap(
				$author$project$Components$StreamAddModal$confirmButtonStyle,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Models$ConfirmStreamAdd)
					])),
			_List_fromArray(
				[
...
var $author$project$Components$StreamAddModal$streamAddModal = function (modal) {
	return A2(
		$elm$html$Html$div,
		$author$project$Components$StreamAddModal$modalStyle,
		_List_fromArray(
			[
				$author$project$Components$StreamAddModal$modalHeader,
				$author$project$Components$StreamAddModal$modalBody(modal.inputText),
				$author$project$Components$StreamAddModal$modalSubmitSection
			]));
};
...
var $author$project$Components$CustomStream$makeIframe = function (stream) {
	return A2(
		...
		_Utils_ap(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src('https://www.youtube-nocookie.com/embed/' + (stream.source + '?autoplay=1&mute=1')),
...
var $author$project$Components$CustomStream$outlineBlockBaseStyle = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'display', 'flex'),
...
var $author$project$Models$DeleteStream = function (a) {
	return {$: 'DeleteStream', a: a};
};
var $author$project$Components$CustomStream$streamToolbarStyle = _Utils_ap(
	$author$project$Styles$flexColumn,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
...
var $author$project$Components$CustomStream$streamToolbar = function (stream) {
	return A2(
		$elm$html$Html$div,
		$author$project$Components$CustomStream$streamToolbarStyle,
		_List_fromArray(
			[
				A2(
				$elm$html$Html$span,
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$author$project$Models$ActivateStream(stream))
						])),
				_List_fromArray(
					[
						$elm$html$Html$text('zoom_in')
					])),
				A2(
				$elm$html$Html$span,
				_Utils_ap(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('material-icons'),
							$elm$html$Html$Events$onClick(
							$author$project$Models$DeleteStream(stream))
						])),
				_List_fromArray(
					[
						$elm$html$Html$text('clear')
...
var $author$project$Components$CustomStream$streamBlock = function (stream) {
	return A2(
		$elm$html$Html$div,
...
var $author$project$Components$CustomStream$keyedStreamBlock = function (stream) {
	return _Utils_Tuple2(
		stream.source,
		A2($elm$html$Html$Lazy$lazy, $author$project$Components$CustomStream$streamBlock, stream));
};
...
var $author$project$Main$streamList = function (streams) {
	return A3(
		...
		A2($elm$core$List$map, $author$project$Components$CustomStream$keyedStreamBlock, streams));
};
var $author$project$Models$OpenAddStreamModal = {$: 'OpenAddStreamModal'};
...
var $author$project$Main$toolbarBlock = A2(
	$elm$html$Html$div,
	$author$project$Styles$toolbarBlockStyle,
	_List_fromArray(
		[
			A2(
			$elm$html$Html$span,
			_Utils_ap(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('material-icons'),
						$elm$html$Html$Events$onClick($author$project$Models$OpenAddStreamModal)
					])),
			_List_fromArray(
				[
					$elm$html$Html$text('add_box')
				]))
		]));
var $author$project$Main$view = function (model) {
	var modal = function () {
		var _v0 = model.modal.isOpened;
		if (_v0) {
			return $author$project$Components$StreamAddModal$streamAddModal(model.modal);
		} else {
	...
	return A2(
		$elm$html$Html$div,
		$author$project$Styles$outerBlockStyle,
		_List_fromArray(
			[
				$author$project$Main$toolbarBlock,
				A2(
				$elm$html$Html$div,
				$author$project$Styles$activeSpaceBlockStyle,
				_List_fromArray(
					[
						$author$project$Main$streamList(model.streams)
					])),
				modal
			]));
};
